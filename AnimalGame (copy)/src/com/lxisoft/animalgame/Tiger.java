...
public class Tiger extends Animal implements Carnivores
{
	/*public Tiger()
	{
		this(animalName,strength,range,isDead,luck,pos,sight,hunger,speed);
	}
	
	public Tiger(String animalName, int strength, int range, boolean isDead, int luck, Position pos, int sight,
			Hunger hunger, int speed)
	{
	super(animalName,strength,range,isDead,luck,pos,sight,hunger,speed);	
