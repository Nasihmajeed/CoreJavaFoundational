...
public class Snake 
{
    public void eBite(ArrayList<Players> player)
    {
	...
	public void hBite(ArrayList<Players> player)
    {
        for(int j=0; j<player.size(); j++)
        {
            if(player.get(j).getPosition()==47)
            ...
            else if(player.get(j).getPosition()==97)
            {
				System.out.println("--------------------------------------------------------------");
				System.out.println("                   There is a Snake at 97 ");
				int place = player.get(j).getPosition();
