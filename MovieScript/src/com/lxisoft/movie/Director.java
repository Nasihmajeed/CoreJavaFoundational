...
public class Director
{
	...
	public void addDialouge(Scanner scanner)
	{
		try
		{
			boolean isTrue = true;
			do 
			{
				...
				{
				case 1:
				   scriptWriter.questionOrAnswer(scanner,scriptWriter.villanQuestionFile,scriptWriter.villanAnswerFile,scriptWriter.villanQuestion,scriptWriter.villanAnswer);
				   break;
				case 2:
				   scriptWriter.questionOrAnswer(scanner,scriptWriter.comedianQuestionFile,scriptWriter.comedianAnswerFile,scriptWriter.comedianQuestion,scriptWriter.comedianAnswer);
				   break;
				case 3:
					isTrue = false;
					break;
