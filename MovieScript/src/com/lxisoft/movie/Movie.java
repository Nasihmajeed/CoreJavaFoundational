...
fr.close();
  ...
  public void addDialogue(){
   ...
   actors.add(new Sundhareshan());
    ...
    actors.add(new Sundhareshan());
    actors.get(2).setDialogue("\nSundhareshan : Aaa padayappaa cinema oke njan kanditullathaa..vekam sthalam vitto..avanu deshyam vanal"+"\n"+" pinne kopayirikum..pidichal kittoolla, vem pokko");
    actors.add(new Basanthi());
    actors.get(3).setDialogue("\nBasanthi : Bukaarooooo");
    actors.add(new Sundhareshan());
    actors.get(4).setDialogue("\nSundhareshan : Aaah Bukaroo train nte samayam onum enik ariyan padilla..bukaro alle veed  ");
    actors.add(new Basanthi());
    ...
    actors.add(new Basanthi());
    actors.get(7).setDialogue("\nBasanthi : (crying again) Bukarooo chinna kuttiii");
    actors.add(new Sundhareshan());
    actors.get(8).setDialogue("\nSundhareshan : Vayattilkai kai vachh chinnakutti nnn paranjall..garbham....garbhaaaanooo");
    actors.add(new Basanthi());
    actors.get(9).setDialogue("\nBasanthi : Haaa garbhaaaanoooa ");
    actors.add(new Sundhareshan());
