...
public class Scenes
{
	...
	public void scenePrint()
	{
		...
		script.add(new Buzz());
				...
				script.get(0).setDialogue1("I can't its my brother after all.");//
				...
				script.get(0).setDialogue5("hmm ,evil has to end somehow.");//
	...
	public void print()
	{
        ...
        //woodie
		System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue0()+"\n"); //buzz
		...
		movie.villain2();
				System.out.println("\u001b[31m\033[1mSid   :\033[0m"+script.get(3).getDialogue3()+"\n"); 
					try
		{
		Thread.sleep(1000);
		}
		...
		System.out.println("\u001b[35m\033[1mWoodie:\033[0m"+script.get(2).getDialogue2()+"\n"); 
			try
		{
		Thread.sleep(950);
		}
		...
		System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue1()+"\n"); //buzz
			System.out.println("\u001b[33m\033[1mJessie:\033[0m"+script.get(1).getDialogue3()+"\n"); //jessie
		...
		Thread.sleep(950);
		...
		catch (InterruptedException e)
            {
				...
				System.out.println("\u001b[35m\033[1mWoodie:\033[0m"+script.get(2).getDialogue4()+"\n"); //woodie
				System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue2()+"\n"); 
					try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
				...
				System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue3()+"\n"); //buzz
						movie.villain3();
					System.out.println("\u001b[31m\033[1mSid   :\033[0m"+script.get(3).getDialogue6()+"\n"); 
					try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
                e.printStackTrace();
					...
					System.out.println("\u001b[31m\033[1mSid   :\033[0m"+script.get(3).getDialogue7()+"\n");
						try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
                e.printStackTrace();
					...
					System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue4()+"\n"); //buzz
						movie.villain4();
					System.out.println("\u001b[35m\033[1mWoodie:\033[0m"+script.get(2).getDialogue5()+"\n"); //woodie
					System.out.println("\u001b[33m\033[1mJessie:\033[0m"+script.get(1).getDialogue4()+"\n");
						try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
                e.printStackTrace();
					...
					System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue5()+"\n"); //buzz
					System.out.println("\u001b[37m\033[1mBuzz  :\033[0m"+script.get(0).getDialogue6()+"\n");
						try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
                e.printStackTrace();
					...
					System.out.println("\u001b[33m\033[1mJessie:\033[0m"+script.get(1).getDialogue5()+"\n");
						try
		{
		Thread.sleep(950);
		}
		catch (InterruptedException e)
            {
                e.printStackTrace();
					...
					System.out.println("\u001b[35m\033[1mWoodie:\033[0m"+script.get(2).getDialogue6()+"\n"); //woodie
						movie.villain5();
