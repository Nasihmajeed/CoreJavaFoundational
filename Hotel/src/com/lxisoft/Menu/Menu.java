...
public ArrayList<Item> su=new ArrayList<Item>();
public void addMenu()
{
itm.add(new Item());
...
for(i=0;i<m;i++)
{
System.out.println("|"+"\t"+(i+1)+"   |"+"\t"+bill.get(i).getName()+"\t"+"|"+qty.get(i).getRate()+"\t"+"|"+"\t"+su.get(i).getRate()+"\t"+"|");
}
System.out.println("|-----------------------------------------------|");
