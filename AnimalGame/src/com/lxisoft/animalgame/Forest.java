...
public class Forest 
{
   	...
   	public void tigerDetails(Animal animalArr[],int t)
    {
	    ...
	    for(int i=0;i<t;i++)
		{
			...
			System.out.println("Tiger Position1:"+tiger.locationX);
			System.out.println("Tiger Position2:"+tiger.locationY);
			tiger.range=20;
			System.out.println("Tiger Range: "+tiger.range);
			tiger.sight=18;
			System.out.println("Tiger Sight: "+tiger.sight);
    ...
    public void lionDetails(Animal animalArr[],int t,int l)
    {
		...
		for(int i=t;i<t+l;i++)
		{
			...
			System.out.println("Lion Position1:"+lion.locationX);
			System.out.println("Lion Position2:"+lion.locationY);
			lion.range=17;
			System.out.println("Lion Range: "+lion.range);
			lion.sight=15;
			System.out.println("Lion Sight: "+lion.sight);
	...
	public void rabbitDetails(Animal animalArr[],int t,int l,int r)
	{
		...
		for(int i=t+l;i<(t+l+r);i++)
		{
			...
			System.out.println("Rabbit Position1:"+rabbit.locationX);
			System.out.println("Rabbit Position2:"+rabbit.locationY);
			rabbit.range=13;
			System.out.println("Rabbit Range: "+rabbit.range);
			rabbit.sight=19;
			System.out.println("Rabbit Sight: "+rabbit.sight);
	...
	public void deerDetails(Animal animalArr[],int t,int l,int r,int d)
	{
	    ...
	    for(int i=(t+l+r);i<tot;i++)
		{
			...
			System.out.println("Deer Position1:"+deer.locationX);
			System.out.println("Deer Position2:"+deer.locationY);
			deer.range=10;
			System.out.println("Deer Range: "+deer.range);
			deer.sight=17;
			System.out.println("Deer Sight: "+deer.sight);
