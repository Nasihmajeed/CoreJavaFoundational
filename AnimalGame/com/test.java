...
// 				if(index!=randomIndex)
// 				{
// 					animalCount = checkInstance();
// 				}
// 			}

// 			public int checkInstance()
// 			{
// 				if(animalList.get(index) instanceof of Herbivores&&animalList.get(randomIndex) instanceof of Herbivores)
// 				{
// 					herbivoresVsHerbivores();					
// 				}
// 				else if(animalList.get(index) instanceof of Carnivores&&animalList.get(randomIndex) instanceof of Carnivores)
// 				{
// 					animalCount = carnivoresVsCarnivores();										
// 				}
// 				else
// 				{
// 					animalCount = herbivoresVsCarnivores();
// 				}
// 			}

// public void herbivoresVsHerbivores()
// {
// 	noFight(animalList,index,randomIndex);
// }
// public int carnivoresVsCarnivores()
// {
// 	checkCoordinates();
// }
// public void herbivoresVsCarnivores()
// {
// 	checkCoordinates();	
// }
// 	public void noFight(ArrayList<Animal> animalList,int index,int randomIndex)
